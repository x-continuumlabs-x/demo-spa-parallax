...
export default function Expertise(){
	...
	return(
		<section data-parallax-section className="z-10 relative w-full overflow-hidden pt-[100px] sm:pt-0 bg-[#a39285]">
			...
			<div data-parallax data-speed="0.7" data-speed-mobile="0.7" className="absolute top-[-11vh] sm:top-[-11vw] left-1/2 -translate-x-1/2 w-[100vw]">
			...
			<div data-parallax data-speed="0.6" data-speed-mobile="0.65" className="absolute top-[5vh] sm:top-[27vw] sm:left-[8.7vw] px-[8%] sm:px-0 sm:w-[28%] text-center sm:text-left text-[#b8bc92]">
			...
			<div ref={cards} data-parallax data-speed="0.6" data-speed-mobile="0.76" id="cardsID" className="absolute top-[79vh] sm:top-[105vw] w-full">
